  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Neumorphism variants for enterprise design
        neu: "neu-button border-0 text-foreground hover:text-primary",
        "neu-primary": "bg-primary-gradient text-primary-foreground shadow-lg hover:shadow-xl",
        "neu-success": "bg-accent text-accent-foreground neu-button hover:bg-accent-hover",
        glass: "glass-card text-foreground hover:bg-background/10 border-0 backdrop-blur-sm",
      },
      size: {
